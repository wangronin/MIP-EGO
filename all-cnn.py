...
def CNN_conf(cfg):
    ...
    if (cfg == 1):
        ...
        cfg['step'] = True
        cfg['global_pooling'] = True
        cfg['activation'] = 'relu'
        cfg['activ_dense'] = 'softmax'
        ...
        verbose = 1
        #epochs=100
    #.993   248	softmax,tanh,0.20205522111180416,0.08374339708355905,0.15862097846997064,0.2228650223250831,30,586,255,118,547,220,512,True,2,3,3,4,1,4,3,0.0003120186044826603,0.012524078856897474,1,2,5,5,4,5,True,0.9931000059843064
